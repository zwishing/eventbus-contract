...
This project is indexed by GitNexus as **eventbus-contract** (1460 symbols, 3173 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
